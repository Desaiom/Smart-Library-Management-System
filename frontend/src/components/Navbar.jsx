...
export default function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: 'var(--sl-primary)' }}>
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navMain">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            {isAuthenticated && (
              <li className="nav-item">
                <NavLink className="nav-link" to="/my-borrows">My Borrows</NavLink>
              </li>
            )}
            {isStaff && (
              <>
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to="/manage-borrows">All Borrows</NavLink>
                </li>
              </>
            )}
            {isAdmin && (
